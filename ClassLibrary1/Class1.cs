...
namespace ClassLibrary1 //namespace Libreria
{
    public class Class1     //    public class Librito
    {

        public static DataSet Ejecutar(string cmd)
        {
            SqlConnection Con = new SqlConnection("server=DESKTOP-LPP55BN;database=TIntegrador; Integrated Security=true;");
            Con.Open();
